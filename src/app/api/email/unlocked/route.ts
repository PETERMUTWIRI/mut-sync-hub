...
//   const org = await prisma.organization.findUnique({ where: { id: orgId }, include: { userProfiles: true } });
//   const user = org?.userProfiles?.[0];
...
//   attachments: [{ filename: 'Newton-Analytics.pdf', data: pdf.toString('base64') }],
//     html: `
