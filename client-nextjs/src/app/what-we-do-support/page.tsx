            ...
            <aside className="lg:w-1/3">
              <Card className="bg-[#1E2A44]/30 border border-[#2E7D7D]/30 shadow-md rounded-xl">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button className="w-full bg-teal-600 text-white hover:bg-teal-700 rounded-lg" onClick={() => setShowAgent(true)}><MessageSquare size={18} className="mr-2" /> 24/7 Live Chat</Button>
                </CardContent>
              </Card>
